...
const CourseList = [
    {
        ...
        url: true,
        courseType: 'Core',
        cell: CourseList=> <Link to={{ pathname: '/material/OfferCourse'}}> {CourseList.course}</Link>
        ...
        <Grid color="primary" container spacing={1} justifyContent="center">
            ...
            <StyledTable>
                ...
                <TableBody>
                    ...
                    <StyledButton onClick={()=> navigate('/material/EvaluateStudents')}>Evaluate Students</StyledButton></label>
                           </TableCell>
                        </TableRow>
                    ))}
                </TableBody>
